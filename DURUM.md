...
| Tarım | Tarla açma (çapa) | SADECE-PLAN | — | item_db.gd'de yalnız isim | — | — | GDD §7 |
| Tarım | Tohum ekme | SADECE-PLAN | — | — | tarla | tohum ITEM'ı var; envanter metni "ekilir" der ama 3D'de ekim kodu YOK (yalnız 2D legacy'de var) | çelişki |
| Tarım | Sulama (bitişik su → tarla) | YARIM | main | world3d.gd:3202 (has_adjacent_water) | boru/su | kanca hazır, tarla sistemi yok | 11.7 kapısı |
| Tarım | Büyüme tick + hasat | SADECE-PLAN | — | — | ekim | — | 2D legacy'de basit hali vardı |
