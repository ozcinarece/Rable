...
| Yaratık | AI (hedef seçimi + yapı kırma, A* YOK) | BRANCH'TE | yaratik-gece | world3d.gd (_tick_one_creature) | gece dalgası | düz yönelme; A* sonraki tur | minimal sürüm |
| Yaratık | Gece dalga sistemi (tek grup) | BRANCH'TE | yaratik-gece | world3d.gd (_spawn_night_wave) | gün döngüsü | gruplu dalga sonraki tur | NIGHTTEST CI'da |
...
| Yaratık | Ocak hedefi | BRANCH'TE | yaratik-gece | world3d.gd (_tick_one_creature) | dalga | sabah ekonomisi/is_banked HÂLÂ YOK | — |
